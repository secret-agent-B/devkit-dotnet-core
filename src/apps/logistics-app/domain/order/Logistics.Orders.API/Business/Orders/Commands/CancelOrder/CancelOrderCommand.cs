// -----------------------------------------------------------------------
// <copyright file="CancelOrderCommand.cs" company="RyanAd">
...
namespace Logistics.Orders.API.Business.Orders.Commands.CancelOrder
{
    ...
    /// <summary>
    /// The CancelOrderCommand is the command that is issued by the driver to cancel the work.
    /// </summary>
    /// <seealso cref="CommandRequestBase{OrderVM}" />
    public class CancelOrderCommand : CommandRequestBase<OrderVM>
    {
        /// <summary>
