...
namespace Logistics.Orders.Test.Fakers
{
    ...
    /// </summary>
    public class SubmitOrderCommandFaker : FakerBase<SubmitOrderCommand>
    {
        /// <summary>
        ...
        /// A list of T.
        /// </returns>
        public override SubmitOrderCommand Generate()
        {
            this.Faker
                .RuleFor(x => x.ItemName, f => f.Commerce.ProductName())
                .RuleFor(x => x.ClientUserName, f => f.Person.UserName)
                ...
                .RuleFor(x => x.SpecialInstructions, f => f.Rant.Reviews(f.Commerce.ProductName(), f.Random.Int(1, 5)).ToList());
